...
//                return RedirectToAction("IniciarSesion", "Home");
        ...
        public ActionResult Agregar_OrdenTrabajo()
        {
            if (System.Web.HttpContext.Current.Session["usuario"] != null)
            {
                ...
                try
                {
                    ...
                    var listaOrdenes = db.sp_Quimipac_ConsultaMT_OrdenTrabajo(empresa, 0).Where(x=> x.Estado == 30 || x.Estado == 31).ToList();
                    ...
                    {
                        itemsProspectos.Add(new SelectListItem { Value = Convert.ToString(prospecto.Id_Prospecto), Text = prospecto.Nombre + " " + prospecto.Codigo_Cliente });
                    }
            ...
            if (System.Web.HttpContext.Current.Session["usuario"] != null)
            {
                try
                {
                    if (ModelState.IsValid)
                    {
                        ...
                        {
                            var empresa_id = System.Web.HttpContext.Current.Session["empresa"];
                            var ordenTrabajo = db.sp_Quimipac_ConsultaMT_OrdenTrabajo(empresa_id.ToString(), 0).ToList().Where(x => x.Codigo_Cliente == mT_OrdenTrabajo.Codigo_Cliente && x.Id_orden_padre == mT_OrdenTrabajo.Id_orden_padre).ToList();
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if (mT_OrdenTrabajo.Id_tipo_trabajo_ejecutado != null)
                                    {
                                        if(mT_OrdenTrabajo.Id_tipo_trabajo_ejecutado != 0)
                                        { 
                                    ...
                                    mT_OrdenTrabajo.Automatizacion = false;
        ...
        public ActionResult Editar_OrdenTrabajo(int id)
        {
            if (System.Web.HttpContext.Current.Session["usuario"] != null)
            {
                ...
                try
                {
                    ...
                    //System.Web.HttpContext.Current.Session["Id_Contrato"] = mT_OrdenTrabajo.Id_contrato; Cambie por id_proyecto
                    ...
                    if (mT_OrdenTrabajo != null)
                    {
                        ...
                        var listaOrdenTrabajo = db.sp_Quimipac_ConsultaMT_OrdenTrabajo(empresa_id.ToString(), 0).Where(x => x.Estado == 30 || x.Estado == 31).ToList();
                        ...
                        foreach (var prospecto in listaProspectos)
                        {
                            ...
                            itemsProspectos.Add(new SelectListItem { Value = Convert.ToString(prospecto.Id_Prospecto), Text = prospecto.Nombre + " " + prospecto.Codigo_Cliente, Selected = seleccion });
                        }
            ...
            if (System.Web.HttpContext.Current.Session["usuario"] != null)
            {
                try
                {
                    if (ModelState.IsValid)
                    {
                        ...
                        {
                            //mT_OrdenTrabajoedit.Id_contrato = Convert.ToInt32(System.Web.HttpContext.Current.Session["Id_Contrato"]); lo cambie por proyecto
                            ...
                            else
                            {
                                ...
                                mT_OrdenTrabajoedit.Automatizacion = Convert.ToBoolean(System.Web.HttpContext.Current.Session["Automatizacion"]);
                                mT_OrdenTrabajoedit.Estado = Convert.ToInt32(System.Web.HttpContext.Current.Session["estado_Orden"]);
                                databaseOrden.InsertarOrdenTrabajoEditNueva(mT_OrdenTrabajoedit.Id_OrdenTrabajo, /*mT_OrdenTrabajoedit.Id_contrato cambie por proyecto*/mT_OrdenTrabajoedit.Id_Proyecto, mT_OrdenTrabajoedit.Id_sucursal,
        ...
        public ActionResult Import(HttpPostedFileBase excelfile, int contrato_excel, string Origen)
        {
                                ...
                                while (reader.Read())
                                {
                                    if (iContador != 0)
                                    {
                                        ...
                                        records.Add(new OrdenTrabajo_Excel
                                        {
                                            ...
                                            fecha_creacion = reader.GetValue(8) == null ? null : reader.GetValue(8).ToString(),
                                            fecha_asignacion = reader.GetValue(9) == null ? null : reader.GetValue(9).ToString(),
                                            Tipo_de_Asignacion = reader.GetValue(10) == null ? "" : reader.GetValue(10).ToString(),
                                            fecha_estimada_eje = reader.GetValue(11) == null ? null : reader.GetValue(11).ToString(),
                                            fecha_max_leg = reader.GetValue(12) == null ? null : reader.GetValue(12).ToString(),
                                            ultimareprog = reader.GetValue(13) == null ? null : reader.GetValue(13).ToString(),
                                            fecha_leg = reader.GetValue(14) == null ? null : reader.GetValue(14).ToString(),
                                            inicio_ej = reader.GetValue(15) == null ? null : reader.GetValue(15).ToString(),
                                            fin_ej = reader.GetValue(16) == null ? null : reader.GetValue(16).ToString(),
                                            Causal_de_Legalizacion = reader.GetValue(17) == null ? "" : reader.GetValue(17).ToString(),
                                            ...
                                            Intentos_de_Legalizacion = reader.GetValue(21) == null ? "" : reader.GetValue(21).ToString(),
                                            ...
                                            hora_acordadas = reader.GetValue(26) == null ? null : reader.GetValue(26).ToString(),
                                            ...
                                            Direccion = reader.GetValue(31) == null ? "" : reader.GetValue(31).ToString(),
                                            Barrio = reader.GetValue(32) == null ? "" : reader.GetValue(32).ToString(),
                                            Ubicacion_Geografica = reader.GetValue(33) == null ? "" : reader.GetValue(33).ToString(),
                                        ...
                                        string Fecha_de_Creacion = reader.GetValue(8) == null ? null : reader.GetValue(8).ToString();
                                        ...
                                        string Fecha_de_Asignacion = reader.GetValue(9) == null ? null : reader.GetValue(9).ToString();
                                        ...
                                        string Tipo_de_Asignacion = reader.GetValue(10) == null ? "" : reader.GetValue(10).ToString();
                                        string Fecha_Estimada_de_Ejecucion = reader.GetValue(11) == null ? null : reader.GetValue(11).ToString();
                                        if (Fecha_Estimada_de_Ejecucion != null)
                                        {
                                            fecha_estimada_eje_ = Convert.ToDateTime(Fecha_Estimada_de_Ejecucion);
                                        }
                                        else { fecha_estimada_eje_ = null; }
                                        string Fecha_Máxima_para_Legalizacion = reader.GetValue(12) == null ? null : reader.GetValue(12).ToString();
                                        if (Fecha_Máxima_para_Legalizacion != null)
                                        {
                                            fecha_max_leg_ = Convert.ToDateTime(Fecha_Máxima_para_Legalizacion);
                                        }
                                        else { fecha_max_leg_ = null; }
                                        string Última_Reprogramacion = reader.GetValue(13) == null ? null : reader.GetValue(13).ToString();
                                        if (Última_Reprogramacion != null)
                                        {
                                            ultimareprog_ = Convert.ToDateTime(Última_Reprogramacion);
                                        }
                                        else { ultimareprog_ = null; } 
                                        string Fecha_de_Legalizacion = reader.GetValue(14) == null ? null : reader.GetValue(14).ToString();
                                        if (Fecha_de_Legalizacion != null)
                                        {
                                            fecha_leg_ = Convert.ToDateTime(Fecha_de_Legalizacion);
                                        }
                                        else { fecha_leg_ = null; }
                                        //string Inicio_de_Ejecucion = reader.GetValue(15) == null ? null : reader.GetValue(15).ToString();
                                        string Inicio_de_Ejecucion = reader.GetValue(9) == null ? null : reader.GetValue(9).ToString();
                                        if (Inicio_de_Ejecucion != null)
                                        {
                                            inicio_ej_ = Convert.ToDateTime(Inicio_de_Ejecucion);
                                        }
                                        else { inicio_ej_ = null; }
                                        string Fin_de_Ejecucion = reader.GetValue(16) == null ? null : reader.GetValue(16).ToString();
                                        if (Fin_de_Ejecucion != null)
                                        {
                                            fin_ej_ = Convert.ToDateTime(Fin_de_Ejecucion);
                                        }
                                        else { fin_ej_ = null; }
                                        string Causal_de_Legalizacion = reader.GetValue(17) == null ? "" : reader.GetValue(17).ToString();
                                        ...
                                        string Intentos_de_Legalizacion = reader.GetValue(21) == null ? "" : reader.GetValue(21).ToString();
                                        ...
                                        string Direccion = reader.GetValue(31) == null ? "" : reader.GetValue(31).ToString();
                                        //string Barrio = reader.GetValue(32) == null ? "" : reader.GetValue(32).ToString();
                                        string Ubicacion_Geográfica = reader.GetValue(33) == null ? "" : reader.GetValue(33).ToString();
                                        ...
                                        if (tipo_trabajo != "")
                                        {
                                                ...
                                                var TRABAJO_split = tipo_trabajo.Split('-');
                                                variable = TRABAJO_split[1].Trim();
                                                variablecodigo = TRABAJO_split[0].Trim();
                                            }
                                        else
                                        {
                                            variable = "";
                                        ...
                                        if (sector != "")
                                        {
                                            ...
                                            variables = sector.Substring(nposs + 1);
                                        ...
                                        if (tipo_trabajo_planeado != "")
                                        {
                                                //int npostp = tipo_trabajo_planeado.IndexOf('-');                                        
                                                //variabletp = tipo_trabajo_planeado.Substring(npostp + 1);
                                                //variabletp = variabletp.TrimStart();
                                                var TRABAJOTP_split = tipo_trabajo_planeado.Split('-');
                                                variabletp = TRABAJOTP_split[1].Trim();
                                                variabletpcodigo = TRABAJOTP_split[0].Trim();
                                            }
                                        else {
                                        ...
                                        if (nivel_prioridad != "")
                                        {
                                            ...
                                            variablenp = nivel_prioridad.Substring(nposnp + 1);
                                        ...
                                        if (barrio != "")
                                        {
                                            ...
                                            variableb = barrio.Substring(nposb + 1);
                                        ...
                                        if (tipo_cliente != "")
                                        {
                                            ...
                                            variablecl = tipo_cliente.Substring(nposcl + 1);
                                        ...
                                        string Hora_Acordada = reader.GetValue(26) == null ? null : reader.GetValue(26).ToString();
                                        if (Hora_Acordada != null)
                                        {
                                            int nposh = Hora_Acordada.IndexOf(' ');
                                            variableh = Hora_Acordada.Substring(nposh + 1);
                                            hora_acordada_ = TimeSpan.Parse(variableh);
                                        }
                                        else
                                        {
                                            hora_acordada_ = null;
                                       ...
                                       bool automatizacion = false;
                                        ...
                                        DataBase_Externo database4 = new DataBase_Externo();
                                            ...
                                            //var OTRepetido = db.sp_Quimipac_ConsultaMT_OrdenTrabajo(empresa_id.ToString(), 0).ToList().Where(x => x.Codigo_Cliente == Identificador && x.Id_contrato == contrato_excel).ToList(); lo cambie por proyecto
                                            if (Origen == "Proyecto")
                                            {
                                                 var OTRepetido = db.sp_Quimipac_ConsultaMT_OrdenTrabajo(empresa_id.ToString(), 0).ToList().Where(x => x.Codigo_Cliente == Identificador && x.Id_Proyecto == contrato_excel).ToList();
                                                if (OTRepetido.Count() <= 0)
                                                {
                                                    if (variable != "")
                                                    {
                                                        ...
                                                        var trabjservplan = from tipotrab in db.MT_TipoTrabajo.Where(vq => vq.Descripcion == variable && vq.Codigo == variablecodigo && vq.Estado == "A" && vq.Id_Cliente == client_contr)
                                                        ...
                                                        var trabjservejec = from tipotrab in db.MT_TipoTrabajo.Where(vq => vq.Descripcion == variabletp && vq.Codigo == variabletpcodigo && vq.Estado == "A" && vq.Id_Cliente == client_contr)
                                                                            join tiposect in db.MT_Servicio.Where(vq => vq.Id_Empresa == empresa_id.ToString())
                                                                            on tipotrab.Id_Servicio equals tiposect.Id_Servicio
                                                                            select new { tipotrab.Id_TipoTrabajo };
                                                        ...
                                                        var trabajoservicioejclist = trabjservejec.ToList();

                                                        DateTime? fecha_maxima_contratista_ = null;
                                                        DateTime? fecha_finalizacion_obra_ = null;

                                                        //var objParametros = db.MT_Contrato_Parametro.Where(vq => vq.Id_Contrato == contrato_excel).SingleOrDefault();
                                                        //if (objParametros != null)
                                                        //{
                                                        //    if (objParametros.Valor_Final != null)
                                                        //    {

                                                        //        DateTime fAsignacion = Convert.ToDateTime(fecha_asignacion_);
                                                        //        fecha_maxima_contratista_ = fAsignacion.AddDays(Convert.ToInt32(objParametros.Valor_Final));
                                                        //    }
                                                        //}
                                                        //else
                                                        //{
                                                        //    fecha_maxima_contratista_ = null;
                                                        //}


                                                        if (trabajoservicioplanlist.Count > 0 && trabajoservicioejclist.Count > 0)
                                                        {
                                                            if (trabajoservicioplanlist.ElementAt(0).Id_TipoTrabajo != null && trabajoservicioejclist.ElementAt(0).Id_TipoTrabajo != null)
                                                            {
                                                                var id_tipo_trabajo_ejecutado = trabajoservicioejclist.ElementAt(0).Id_TipoTrabajo;
                                                                var dias_proceso = db.MT_TipoTrabajo.Where(x => x.Id_TipoTrabajo == id_tipo_trabajo_ejecutado).Select(x => x.Proceso).FirstOrDefault();

                                                                if (dias_proceso != null)
                                                                {

                                                                    DateTime fAsignacion = Convert.ToDateTime(fecha_asignacion_);
                                                                    fecha_maxima_contratista_ = fAsignacion.AddHours(Convert.ToInt32(dias_proceso));
                                                                    fecha_finalizacion_obra_ = fAsignacion.AddHours(Convert.ToInt32(dias_proceso));

                                                                }
                                                                else
                                                                {
                                                                    fecha_maxima_contratista_ = null;
                                                                    fecha_finalizacion_obra_ = null;
                                                                }


                                                                var ac = database4.IngresarOrdenes_Excel(Identificador, Numerador, Estado, Producto, Unidad_de_Trabajo, Estado_Unidad_de_Trabajo, fecha_creacion_, fecha_asignacion_, Tipo_de_Asignacion, fecha_estimada_eje_, fecha_max_leg_, ultimareprog_, fecha_leg_, inicio_ej_, fin_ej_, Causal_de_Legalizacion, Personal, Valor_de_la_Orden, Número_de_Veces_Impresa, Intentos_de_Legalizacion, Anula_Otra_Orden, Tipo_de_Compromiso, Cita_Confirmada, Consecutivo_Ruta, Ruta, Nombre_Ruta, Direccion, Ubicacion_Geográfica, Cliente, Nombre_Suscriptor, Apellido_Suscriptor, Teléfono_Cliente, Puntaje_Cliente, Esfuerzo_de_la_Orden, Comentario, Tipo_de_Comentario, Unidad_Asociada, Ofertada, Proyecto, Etapa, Estado_de_la_Orden, PARENT_ID, variable, variables, variabletp, variablenp, variableb, variablecl, hora_acordada_, usuario, contrato_excel, empresa_id.ToString(), fecha_maxima_contratista_, fecha_finalizacion_obra_, automatizacion, variablecodigo, variabletpcodigo, Origen);
                                                                if (ac != -1)
                                                                {
                                                ...
                                                var  OTRepetido = db.sp_Quimipac_ConsultaMT_OrdenTrabajo(empresa_id.ToString(), 0).ToList().Where(x => x.Codigo_Cliente == Identificador && x.Id_Prospecto == contrato_excel).ToList();
                                                if (OTRepetido.Count() <= 0)
                                                {
                                                    if (variable != "")
                                                    {
            ...
            catch (Exception e)
            {
                ...
                //return RedirectToAction("Error", "Errores");
                Console.Write(e.Message); return RedirectToAction("OrdenTrabajo");
            }
        }
        ...
        #region
        [HttpPost]
        public ActionResult OrdenTrabajo([Bind(Include = "Fecha_asignacion_grupo_trabajo, Fecha_asignacion, Fecha_registro,Origen,Id_tipo_trabajo_ejecutado,Id_campamento,Id_estacion,Id_sector,Id_sucursal,Id_contrato,Estado,cod_cli, Etapa, Id_OrdenTrabajo")]Orden_Trabajo_FiltCli ORDEN)
        {
            try
            {
        ...
        public ActionResult Editar_AsignarGrupo_OrdenTrabajo(int id)
        {
            try
            {
                ...
                //var clientes = db.MT_Contrato.Find(mT_OrdenTrabajo.Id_contrato); lo cambie por proyecto
       ...
       public JsonResult Guardar_Editar_AsignarGrupo_OrdenTrabajo(int? Id_ClienteGrupoOrden, List<int> resultadoChecked, List<int> resultadoCheckTotal, int? Id_Cliente, DateTime? FechaEnvio, DateTime? FechaRecep, int? Id_Grupo)
        ...
        public ActionResult OrdenTrabajo_Filter(DateTime? Fecha_Inicio, DateTime? Fecha_registro, List<string> check_parametro, string SelectedAndOr, int? MenuSelectedFecha)
        {
            ...
            try
            {
                ...
                var ContratosLI = db.sp_Quimipac_ConsultaMT_Permisos_xClienteUsuarioID(usuario.ToString(), empresa_id.ToString(), "CONTRATOS").ToList();
                var listakContrato = db.MT_Contrato.Where(vq => ContratosLI.Contains(vq.Id_Cliente)).ToList();
                //lkbusqueda = lkbusqueda.Where(vq => ContratosLI.Contains(vq.Id_contrato.ToString())).ToList(); lo cambie por proyecto
