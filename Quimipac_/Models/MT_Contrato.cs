...
namespace Quimipac_.Models
{
    ...
    public partial class MT_Contrato
    {
        ...
        public MT_Contrato()
        {
            this.MT_Contrato_Documentado = new HashSet<MT_Contrato_Documentado>();
            this.MT_Contrato_Prorroga = new HashSet<MT_Contrato_Prorroga>();
            this.MT_ContratoAlerta = new HashSet<MT_ContratoAlerta>();
        }
        ...
        public virtual ICollection<MT_Contrato_Documentado> MT_Contrato_Documentado { get; set; }
        public virtual MT_TablaDetalle MT_TablaDetalle { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<MT_Contrato_Prorroga> MT_Contrato_Prorroga { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<MT_ContratoAlerta> MT_ContratoAlerta { get; set; }
    }
}
